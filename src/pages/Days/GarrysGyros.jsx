  ...
  return (
    <main className="garrys-page">
      <style>{`
        ...
        .garrys-google-maps-button:hover {
          transform: translateY(-3px);
      ...
      <div className="garrys-waze-wrapper">
        ...
        <a
          className="garrys-google-maps-button"
          href="https://www.google.com/maps/dir/?api=1&destination=40.00082203892744,23.57373078465639"
        >
          🗺️ Google Maps ל-Garry's The King of Gyros
        </a>
      </div>
