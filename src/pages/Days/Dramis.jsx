  ...
  return (
    <main className="dramis-page">
      <style>{`
        ...
        .dramis-google-maps-button:hover {
          transform: translateY(-3px);
      ...
      <div className="dramis-waze-wrapper">
        ...
        <a
          className="dramis-google-maps-button"
          href="https://www.google.com/maps/dir/?api=1&destination=39.99999493464846,23.572445028835894"
        >
          🗺️ Google Maps ל-Dramis
        </a>
      </div>
